...
class StringToLowerTestFixture : public CppUnit::TestFixture {

CPPUNIT_TEST_SUITE( StringToLowerTestFixture );
    CPPUNIT_TEST( testEightBitToLowers );
    CPPUNIT_TEST( testTurkishToLowers );
    CPPUNIT_TEST( testSixteenBitToLowers );
    CPPUNIT_TEST( testThirtyTwoBitToLowers );
    CPPUNIT_TEST( testPageZeroUnshiftables );
    CPPUNIT_TEST( testPageOneUnshiftables );
...
public:
    void testEightBitToLowers();
    void testTurkishToLowers();
    void testSixteenBitToLowers();
    void testThirtyTwoBitToLowers();

    void testPageZeroUnshiftables();
    void testPageOneUnshiftables();
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(StringToLowerTestFixture, "StringClassTests");

void StringToLowerTestFixture::testEightBitToLowers()
{
...
void StringToLowerTestFixture::testTurkishToLowers()
{
    ...
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "tur"));
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "az"));
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "aze"));
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "azb"));
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "azj"));
    CPPUNIT_ASSERT_EQUAL(lowerCaseT, toLower(upperCaseT, "tt"));
    ...
    CPPUNIT_ASSERT(lowerCaseT16 != toLower(upperCaseT16));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "tr"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "tur"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "az"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "aze"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "azb"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "azj"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "tt"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "tat"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "kk"));
    CPPUNIT_ASSERT(lowerCaseT16 == toLower(upperCaseT16, "kaz"));
    ...
    CPPUNIT_ASSERT(lowerCaseT32 != toLower(upperCaseT32));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "tr"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "tur"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "az"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "aze"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "azb"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "azj"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "tt"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "tat"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "kk"));
    CPPUNIT_ASSERT(lowerCaseT32 ==  toLower(upperCaseT32, "kaz"));
}
...
void StringToLowerTestFixture::testSixteenBitToLowers()
{
    ...
    ucs2String
      ...
      u24(u"\u10C4\u10C5\u10C7\u10CD\u13A0\u13A1\u13A2\u13A3\u13A4\u13A5\u13A6\u13A7\u13A8\u13A9\u13AA\u13AB\u13AC\u13AD\u13AE\u13AF\u13B0"),
      u25(u"\u13B1\u13B2\u13B3\u13B4\u13B5\u13B6\u13B7\u13B8\u13B9\u13BA\u13BB\u13BC\u13BD\u13BE\u13BF\u13C0\u13C1\u13C2\u13C3\u13C4\u13C5"),
      u26(u"\u13C6\u13C7\u13C8\u13C9\u13CA\u13CB\u13CC\u13CD\u13CE\u13CF\u13D0\u13D1\u13D2\u13D3\u13D4\u13D5\u13D6\u13D7\u13D8\u13D9\u13DA"),
      u27(u"\u13DB\u13DC\u13DD\u13DE\u13DF\u13E0\u13E1\u13E2\u13E3\u13E4\u13E5\u13E6\u13E7\u13E8\u13E9\u13EA\u13EB\u13EC\u13ED\u13EE\u13EF"),
      u28(u"\u13F0\u13F1\u13F2\u13F3\u13F4\u13F5\u1E00\u1E02\u1E04\u1E06\u1E08\u1E0A\u1E0C\u1E0E\u1E10\u1E12\u1E14\u1E16\u1E18\u1E1A\u1E1C"),
    ...
    ucs2String
      ...
      l24(u"\u2D24\u2D25\u2D27\u2D2D\uAB70\uAB71\uAB72\uAB73\uAB74\uAB75\uAB76\uAB77\uAB78\uAB79\uAB7A\uAB7B\uAB7C\uAB7D\uAB7E\uAB7F\uAB80"),
      l25(u"\uAB81\uAB82\uAB83\uAB84\uAB85\uAB86\uAB87\uAB88\uAB89\uAB8A\uAB8B\uAB8C\uAB8D\uAB8E\uAB8F\uAB90\uAB91\uAB92\uAB93\uAB94\uAB95"),
      l26(u"\uAB96\uAB97\uAB98\uAB99\uAB9A\uAB9B\uAB9C\uAB9D\uAB9E\uAB9F\uABA0\uABA1\uABA2\uABA3\uABA4\uABA5\uABA6\uABA7\uABA8\uABA9\uABAA"),
      l27(u"\uABAB\uABAC\uABAD\uABAE\uABAF\uABB0\uABB1\uABB2\uABB3\uABB4\uABB5\uABB6\uABB7\uABB8\uABB9\uABBA\uABBB\uABBC\uABBD\uABBE\uABBF"),
      l28(u"\u13F8\u13F9\u13FA\u13FB\u13FC\u13FD\u1E01\u1E03\u1E05\u1E07\u1E09\u1E0B\u1E0D\u1E0F\u1E11\u1E13\u1E15\u1E17\u1E19\u1E1B\u1E1D"),
    ...
    x|= (l25 == toLower(u25)) ? 0b10000000000000000000000000 : 0;   // good
    x|= (l26 == toLower(u26)) ? 0b100000000000000000000000000 : 0;  // good
    x|= (l27 == toLower(u27)) ? 0b1000000000000000000000000000 : 0;
    x|= (l28 == toLower(u28)) ? 0b10000000000000000000000000000 : 0;    // good
    ...
    CPPUNIT_ASSERT(l03 == toLower(l03));
    CPPUNIT_ASSERT(l04 == toLower(l04));
    CPPUNIT_ASSERT(l05 == toLower(l05));
    CPPUNIT_ASSERT(l06 == toLower(l06));
    CPPUNIT_ASSERT(l07 == toLower(l07));
    CPPUNIT_ASSERT(l08 == toLower(l08));
    CPPUNIT_ASSERT(l09 == toLower(l09));
    CPPUNIT_ASSERT(l10 == toLower(l10));
    CPPUNIT_ASSERT(l11 == toLower(l11));
    CPPUNIT_ASSERT(l12 == toLower(l12));
    CPPUNIT_ASSERT(l13 == toLower(l13));
    CPPUNIT_ASSERT(l14 == toLower(l14));
    CPPUNIT_ASSERT(l15 == toLower(l15));
    CPPUNIT_ASSERT(l16 == toLower(l16));
    CPPUNIT_ASSERT(l17 == toLower(l17));
    CPPUNIT_ASSERT(l18 == toLower(l18));
    CPPUNIT_ASSERT(l19 == toLower(l19));
    CPPUNIT_ASSERT(l20 == toLower(l20));
    CPPUNIT_ASSERT(l21 == toLower(l21));
    CPPUNIT_ASSERT(l22 == toLower(l22));
    CPPUNIT_ASSERT(l23 == toLower(l23));
    CPPUNIT_ASSERT(l24 == toLower(l24));
    CPPUNIT_ASSERT(l25 == toLower(l25));
    CPPUNIT_ASSERT(l26 == toLower(l26));
    CPPUNIT_ASSERT(l27 == toLower(l27));
    CPPUNIT_ASSERT(l28 == toLower(l28));
    CPPUNIT_ASSERT(l29 == toLower(l29));
    CPPUNIT_ASSERT(l30 == toLower(l30));
    CPPUNIT_ASSERT(l31 == toLower(l31));
    CPPUNIT_ASSERT(l32 == toLower(l32));
    CPPUNIT_ASSERT(l33 == toLower(l33));
    CPPUNIT_ASSERT(l34 == toLower(l34));
    CPPUNIT_ASSERT(l35 == toLower(l35));
    CPPUNIT_ASSERT(l36 == toLower(l36));
    CPPUNIT_ASSERT(l37 == toLower(l37));
    CPPUNIT_ASSERT(l38 == toLower(l38));
    CPPUNIT_ASSERT(l39 == toLower(l39));
    CPPUNIT_ASSERT(l40 == toLower(l40));
    CPPUNIT_ASSERT(l41 == toLower(l41));
    CPPUNIT_ASSERT(l42 == toLower(l42));
    CPPUNIT_ASSERT(l43 == toLower(l43));
    CPPUNIT_ASSERT(l44 == toLower(l44));
    CPPUNIT_ASSERT(l45 == toLower(l45));
    CPPUNIT_ASSERT(l46 == toLower(l46));
    CPPUNIT_ASSERT(l47 == toLower(l47));
    CPPUNIT_ASSERT(l48 == toLower(l48));
    CPPUNIT_ASSERT(l49 == toLower(l49));
...
void StringToLowerTestFixture::testThirtyTwoBitToLowers()
{
    ...
    {   // 0.00 - x
        ...
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    {   //

        result |= lowerCase == toLower(upperCase) ? flag : 0;
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    {   // 1.58 - x
        ucs4String upperCase(U"\U0000FF27\U0000FF28\U0000FF29\U0000FF2A\U0000FF2B\U0000FF2C\U0000FF2D\U0000FF2E\U0000FF2F");
        ucs4String lowerCase(U"\U0000FF47\U0000FF48\U0000FF49\U0000FF4A\U0000FF4B\U0000FF4C\U0000FF4D\U0000FF4E\U0000FF4F");
        result |= lowerCase == toLower(upperCase) ? flag : 0;
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    {   // 1.59 - x
        ucs4String upperCase(U"\U0000FF30\U0000FF31\U0000FF32\U0000FF33\U0000FF34\U0000FF35\U0000FF36\U0000FF37\U0000FF38");
        ucs4String lowerCase(U"\U0000FF50\U0000FF51\U0000FF52\U0000FF53\U0000FF54\U0000FF55\U0000FF56\U0000FF57\U0000FF58");
        result |= lowerCase == toLower(upperCase) ? flag : 0;
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    {   // 1.60 - x
        ucs4String upperCase(U"\U0000FF39\U0000FF3A\U00010400\U00010401\U00010402\U00010403\U00010404\U00010405\U00010406");
        ucs4String lowerCase(U"\U0000FF59\U0000FF5A\U00010428\U00010429\U0001042A\U0001042B\U0001042C\U0001042D\U0001042E");
        result |= lowerCase == toLower(upperCase) ? flag : 0;
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    {   // 1.61 - x
        ucs4String upperCase(U"\U00010407\U00010408\U00010409\U0001040A\U0001040B\U0001040C\U0001040D\U0001040E\U0001040F");
        ucs4String lowerCase(U"\U0001042F\U00010430\U00010431\U00010432\U00010433\U00010434\U00010435\U00010436\U00010437");
        result |= lowerCase == toLower(upperCase) ? flag : 0;
        flag <<= 1;
        CPPUNIT_ASSERT(lowerCase == toLower(lowerCase));
    }
    ...
    CPPUNIT_ASSERT_EQUAL( 0x7FFFFFFFFFFFFFFF, result0 );
    CPPUNIT_ASSERT_EQUAL( 0x7FFFFFFFFFFFFFFF, result1 );
    CPPUNIT_ASSERT_EQUAL( static_cast<int64_t>(0x7FFFF), result2 );
}

void StringToLowerTestFixture::testPageZeroUnshiftables()
{
    {
        ...
        CPPUNIT_ASSERT_EQUAL(dontTouch00, toLower(dontTouch00));
    }

    {
        ...
        CPPUNIT_ASSERT(dontTouch01 == toLower(dontTouch01));
    }

    {
        ...
        CPPUNIT_ASSERT(dontTouch02 == toLower(dontTouch02));
    }

    {
        ...
        CPPUNIT_ASSERT(dontTouch03 == toLower(dontTouch03));
    }

    {
        ucs2String dontTouch04(u"\u0482\u0483\u0484\u0485\u0486\u0487\u0488\u0489\u04CF");

        CPPUNIT_ASSERT(dontTouch04 == toLower(dontTouch04));
    }

    {
        ...
        CPPUNIT_ASSERT(dontTouch05 == toLower(dontTouch05));
    }
}

void StringToLowerTestFixture::testPageOneUnshiftables()
{
    ...
    CPPUNIT_ASSERT(dontTouchP1 == toLower(dontTouchP1));
}

void StringToLowerTestFixture::testPageTwoUnshiftables()
{
    ucs2String dontTouchP2(u"\u215f\u2180\u2181\u2182\u2185\u2186\u2187\u2188\u2189"
                           ...
                           u"\u2cf4\u2cf5\u2cf6\u2cf7\u2cf8\u2cf9\u2cfa\u2cfb\u2cfc\u2cfd\u2cfe\u2cff"
                           u"\u2d26\u2d28\u2d29\u2d2a\u2d2b\u2d2c\u2d2e\u2d2f\u2d30");
    CPPUNIT_ASSERT(dontTouchP2 == toLower(dontTouchP2));
}

void StringToLowerTestFixture::testPageAToFUnshiftables()
{
    ucs2String dontTouchPAtoF(u"\ua5ff\ua60b\ua617\ua623\ua630\ua637\ua63c\ua63d\ua63e\ua63f"
                              ...
                              u"\uff00\uff04\uff08\uff0c\uff10\uff18\uff1c\uff1f\uff20"
                              u"\uff3b\uff3c\uff3d\uff3e\uff3f\uff40\uff5b\uff5c\uff5d\uff5e\uff5f\uff60");
    CPPUNIT_ASSERT(dontTouchPAtoF == toLower(dontTouchPAtoF));
}

void StringToLowerTestFixture::testPlane1Unshiftables()
{
