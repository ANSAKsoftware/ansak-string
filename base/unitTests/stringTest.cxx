...
{
    char16_t d;
    CPPUNIT_ASSERT_EQUAL(d = 0x80, decodeUtf8(0xc2, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x100, decodeUtf8(0xc4, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x200, decodeUtf8(0xc8, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x400, decodeUtf8(0xd0, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x600, decodeUtf8(0xd8, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x700, decodeUtf8(0xdc, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x780, decodeUtf8(0xde, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x7c0, decodeUtf8(0xdf, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x7e0, decodeUtf8(0xdf, 0xa0));
    CPPUNIT_ASSERT_EQUAL(d = 0x7f0, decodeUtf8(0xdf, 0xb0));
    CPPUNIT_ASSERT_EQUAL(d = 0x7f8, decodeUtf8(0xdf, 0xb8));
    CPPUNIT_ASSERT_EQUAL(d = 0x7fc, decodeUtf8(0xdf, 0xbc));
    CPPUNIT_ASSERT_EQUAL(d = 0x7fe, decodeUtf8(0xdf, 0xbe));
    CPPUNIT_ASSERT_EQUAL(d = 0x7ff, decodeUtf8(0xdf, 0xbf));
    CPPUNIT_ASSERT_EQUAL(d = 0x1000, decodeUtf8(0xe1, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x2000, decodeUtf8(0xe2, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x4000, decodeUtf8(0xe4, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0x8000, decodeUtf8(0xe8, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xc000, decodeUtf8(0xec, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xe000, decodeUtf8(0xee, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xf000, decodeUtf8(0xef, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xf800, decodeUtf8(0xef, 0xa0, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xfc00, decodeUtf8(0xef, 0xb0, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xfe00, decodeUtf8(0xef, 0xb8, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xff00, decodeUtf8(0xef, 0xbc, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xff80, decodeUtf8(0xef, 0xbe, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xffc0, decodeUtf8(0xef, 0xbf, 0x80));
    CPPUNIT_ASSERT_EQUAL(d = 0xffe0, decodeUtf8(0xef, 0xbf, 0xa0));
    CPPUNIT_ASSERT_EQUAL(d = 0xfff0, decodeUtf8(0xef, 0xbf, 0xb0));
    CPPUNIT_ASSERT_EQUAL(d = 0xfff8, decodeUtf8(0xef, 0xbf, 0xb8));
    CPPUNIT_ASSERT_EQUAL(d = 0xfffc, decodeUtf8(0xef, 0xbf, 0xbc));
    CPPUNIT_ASSERT_EQUAL(d = 0xfffe, decodeUtf8(0xef, 0xbf, 0xbe));
    CPPUNIT_ASSERT_EQUAL(d = 0xffff, decodeUtf8(0xef, 0xbf, 0xbf));
    char32_t e;
    CPPUNIT_ASSERT_EQUAL(e = 0x10000, decodeUtf8(0xf0, 0x90, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x20000, decodeUtf8(0xf0, 0xa0, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x40000, decodeUtf8(0xf1, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x80000, decodeUtf8(0xf2, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x100000, decodeUtf8(0xf4, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x180000, decodeUtf8(0xf6, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1c0000, decodeUtf8(0xf7, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1e0000, decodeUtf8(0xf7, 0xa0, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1f0000, decodeUtf8(0xf7, 0xb0, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1f8000, decodeUtf8(0xf7, 0xb8, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fc000, decodeUtf8(0xf7, 0xbc, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fe000, decodeUtf8(0xf7, 0xbe, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ff000, decodeUtf8(0xf7, 0xbf, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ff800, decodeUtf8(0xf7, 0xbf, 0xa0, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffc00, decodeUtf8(0xf7, 0xbf, 0xb0, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffe00, decodeUtf8(0xf7, 0xbf, 0xb8, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fff00, decodeUtf8(0xf7, 0xbf, 0xbc, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fff80, decodeUtf8(0xf7, 0xbf, 0xbe, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fffc0, decodeUtf8(0xf7, 0xbf, 0xbf, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fffe0, decodeUtf8(0xf7, 0xbf, 0xbf, 0xa0));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffff0, decodeUtf8(0xf7, 0xbf, 0xbf, 0xb0));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffff8, decodeUtf8(0xf7, 0xbf, 0xbf, 0xb8));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffffc, decodeUtf8(0xf7, 0xbf, 0xbf, 0xbc));
    CPPUNIT_ASSERT_EQUAL(e = 0x1ffffe, decodeUtf8(0xf7, 0xbf, 0xbf, 0xbe));
    CPPUNIT_ASSERT_EQUAL(e = 0x1fffff, decodeUtf8(0xf7, 0xbf, 0xbf, 0xbf));

    CPPUNIT_ASSERT_EQUAL(e = 0x200000, decodeUtf8(0xf8, 0x88, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x400000, decodeUtf8(0xf8, 0x90, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x800000, decodeUtf8(0xf8, 0xa0, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x1000000, decodeUtf8(0xf9, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x2000000, decodeUtf8(0xfa, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3000000, decodeUtf8(0xfb, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3800000, decodeUtf8(0xfb, 0xa0, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3c00000, decodeUtf8(0xfb, 0xb0, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3e00000, decodeUtf8(0xfb, 0xb8, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3f00000, decodeUtf8(0xfb, 0xbc, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3f80000, decodeUtf8(0xfb, 0xbe, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3fc0000, decodeUtf8(0xfb, 0xbf, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3fff000, decodeUtf8(0xfb, 0xbf, 0xbf, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x3ffffff, decodeUtf8(0xfb, 0xbf, 0xbf, 0xbf, 0xbf));

    CPPUNIT_ASSERT_EQUAL(e = 0x4000000, decodeUtf8(0xfc, 0x84, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x8000000, decodeUtf8(0xfc, 0x88, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x10000000, decodeUtf8(0xfc, 0x90, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x20000000, decodeUtf8(0xfc, 0xa0, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x40000000, decodeUtf8(0xfd, 0x80, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x60000000, decodeUtf8(0xfd, 0xa0, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x70000000, decodeUtf8(0xfd, 0xb0, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x7f000000, decodeUtf8(0xfd, 0xbf, 0x80, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x7ffc0000, decodeUtf8(0xfd, 0xbf, 0xbf, 0x80, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x7ffff000, decodeUtf8(0xfd, 0xbf, 0xbf, 0xbf, 0x80, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x7fffffc0, decodeUtf8(0xfd, 0xbf, 0xbf, 0xbf, 0xbf, 0x80));
    CPPUNIT_ASSERT_EQUAL(e = 0x7fffffff, decodeUtf8(0xfd, 0xbf, 0xbf, 0xbf, 0xbf, 0xbf));
}
